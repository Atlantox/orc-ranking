        ...
        <table class="w-100 h6 m-0 text-white" id="normal-dt">
            ...
            <tbody class="fs-5">
                ...
                :key="player.id">
                    ...
                    <td class="border-green text-center">{{ player.points }}</td>
                    <td class="border-green text-center">{{ player.tournaments }}</td>
                    <td class="border-green text-center">{{ player.wins }}</td>
