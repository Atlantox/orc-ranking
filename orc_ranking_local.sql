...
-- Volcando estructura para tabla orc_ranking.binnacle
...
-- Volcando datos para la tabla orc_ranking.binnacle: ~49 rows (aproximadamente)
INSERT INTO `binnacle` (`id`, `user`, `action`, `date`, `ip_address`) VALUES
	...
	(252, 10, 'Creó el deck Emmara, Soul of the Accord', '2024-09-01 22:45:07', '10.0.5.105'),
	(253, 10, 'Creó el deck The Scarab God', '2024-09-01 22:45:35', '10.0.5.105'),
	(254, 10, 'Creó el deck Tayam, enigma resplandeciente', '2024-09-01 22:46:33', '10.0.5.105'),
	(255, 10, 'Creó al jugador Katsura', '2024-09-01 22:47:07', '10.0.5.105'),
	(256, 10, 'Creó al jugador Nelson', '2024-09-01 22:47:14', '10.0.5.105'),
	(257, 10, 'Creó el torneo del día 2024-09-01', '2024-09-01 22:52:25', '10.0.5.105'),
	(258, 10, 'Creó al jugador Ricardo Mendoza', '2024-09-01 23:05:15', '10.0.5.105'),
	(259, 10, 'Renombró al jugador "Ricardo" por "Ricardo Dragones" ', '2024-09-01 23:05:29', '10.0.5.105'),
	(260, 10, 'Modificó el deck "29"', '2024-09-02 00:12:43', '10.0.5.105'),
	(261, 10, 'Atlantox ha ingresado al sistema', '2025-11-01 12:14:35', '127.0.0.1'),
	(262, 10, 'Creó el torneo del día 2025-10-29', '2025-11-01 12:47:31', '127.0.0.1'),
	(263, 10, 'Atlantox ha ingresado al sistema', '2025-11-01 13:11:50', '127.0.0.1'),
	(264, 10, 'Creó la temporada del 2025-11-01', '2025-11-01 15:36:55', '127.0.0.1'),
	(265, 10, 'Creó el torneo del día 2025-10-31', '2025-11-01 16:10:32', '127.0.0.1'),
	(266, 10, 'Atlantox ha ingresado al sistema', '2025-11-01 17:08:32', '127.0.0.1'),
	(267, 10, 'Creó el warning al jugador Alexander por motivo Se puso a gritar', '2025-11-01 18:50:43', '127.0.0.1'),
	(268, 10, 'Creó el warning al jugador Antoanel por motivo asdawdawd', '2025-11-01 18:51:19', '127.0.0.1'),
	(269, 10, 'Creó el warning al jugador Mark por motivo xzcasga', '2025-11-01 18:51:49', '127.0.0.1'),
	(270, 10, 'Creó el warning al jugador Boros por motivo adwadad', '2025-11-01 18:53:15', '127.0.0.1'),
	(271, 10, 'Creó el warning al jugador Antoanel por motivo dawdwadadaw', '2025-11-01 18:53:47', '127.0.0.1'),
	(272, 10, 'Creó el warning al jugador Yeshirler Rodríguez por motivo xfxjhfhg', '2025-11-01 18:55:08', '127.0.0.1'),
	(273, 10, 'Creó el warning al jugador Alexander por motivo eaghaesr srjh<r', '2025-11-01 19:44:54', '127.0.0.1');

-- Volcando estructura para tabla orc_ranking.color
CREATE TABLE IF NOT EXISTS `color` (
  `name` varchar(10) NOT NULL,
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Volcando datos para la tabla orc_ranking.color: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla orc_ranking.deck
...
-- Volcando datos para la tabla orc_ranking.deck: ~28 rows (aproximadamente)
...
-- Volcando estructura para tabla orc_ranking.deck_color
CREATE TABLE IF NOT EXISTS `deck_color` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando datos para la tabla orc_ranking.deck_color: ~67 rows (aproximadamente)
...
-- Volcando estructura para tabla orc_ranking.game_format
...
-- Volcando datos para la tabla orc_ranking.game_format: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla orc_ranking.permisson
...
-- Volcando datos para la tabla orc_ranking.permisson: ~23 rows (aproximadamente)
...
-- Volcando estructura para tabla orc_ranking.player
...
-- Volcando datos para la tabla orc_ranking.player: ~24 rows (aproximadamente)
...
-- Volcando estructura para tabla orc_ranking.season
...
-- Volcando datos para la tabla orc_ranking.season: ~2 rows (aproximadamente)
INSERT INTO `season` (`id`, `name`, `date`, `active`) VALUES
	(1, '1', '2024-08-16', 0),
	(2, '2', '2025-11-01', 1);

-- Volcando estructura para tabla orc_ranking.tournament
...
-- Volcando datos para la tabla orc_ranking.tournament: ~5 rows (aproximadamente)
INSERT INTO `tournament` (`id`, `date`, `format`, `observation`, `season`, `active`, `pot`) VALUES
	(2, '2024-08-18', 'Coliseo', '', 1, 1, 1.00),
	(3, '2024-08-25', 'Coliseo', '', 1, 1, 2.00),
	(4, '2024-09-01', 'Coliseo', '', 1, 1, 5.00),
	(5, '2025-10-29', 'Coliseo Duel', '', 1, 1, 3.00),
	(6, '2025-10-31', 'Coliseo', '', 2, 1, 0.00);

-- Volcando estructura para tabla orc_ranking.tournament_result
...
-- Volcando datos para la tabla orc_ranking.tournament_result: ~48 rows (aproximadamente)
...
-- Volcando estructura para tabla orc_ranking.user
...
-- Volcando datos para la tabla orc_ranking.user: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla orc_ranking.user_level
CREATE TABLE IF NOT EXISTS `user_level` (
  `name` varchar(20) NOT NULL,
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Volcando datos para la tabla orc_ranking.user_level: ~3 rows (aproximadamente)
INSERT INTO `user_level` (`name`) VALUES
	('Admin'),
	('Editor'),
	('Super');

-- Volcando estructura para tabla orc_ranking.warning
CREATE TABLE IF NOT EXISTS `warning` (
  ...
  PRIMARY KEY (`id`),
  KEY `warning_player` (`player`),
  KEY `warning_season` (`season`),
  CONSTRAINT `warning_player` FOREIGN KEY (`player`) REFERENCES `player` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `warning_season` FOREIGN KEY (`season`) REFERENCES `season` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Volcando datos para la tabla orc_ranking.warning: ~0 rows (aproximadamente)
